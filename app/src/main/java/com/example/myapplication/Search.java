...
public class Search extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spiner=findViewById(R.id.categourie);
        Spinner spinner=findViewById(R.id.wilaya);
      ArrayAdapter<CharSequence> adapte=ArrayAdapter.createFromResource(this,R.array.categouries, android.R.layout.simple_spinner_item);
        ArrayAdapter<CharSequence> adapter=ArrayAdapter.createFromResource(this,R.array.wilayas, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
         adapte.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
       spiner.setAdapter(adapte);
        ...
        bottomNavigation.setOnShowListener(new MeowBottomNavigation.ShowListener() {
            ...
            public void onShowItem(MeowBottomNavigation.Model item) {
                ...
                switch (item.getId()) {
                    ...
                    case 2: intent = new Intent(getApplicationContext(),Search.class);
                        startActivity(intent);
                        break;
